...
<head>
    ...
    <title>WeeklyPic-One-Stop-Foto - Benutzer</title>
    <style type="text/css">
        body {
            margin: 30px auto;
            max-width: 650px;
...
<ul>
    ...
    <li>Das zweite Feld ist der Name mit dem der Benutzer in der App angeredet wird. Ist dieser nicht angegeben, wird
        der Slack-Name verwendet.
    </li>
...
Marie;;Marie.Curie@example.com</pre>
</p>
...
<p>Hier geht es <a href="index.php">zurück ohne zu speichern!</a>.</p>
