...
<html lang="de">
  <head>
    ...
    <style type="text/css">
      ...
      th {text-align: left;}
      th,td {padding: 5px; padding-right: 15px;}
      a.btn {background-color: slategray; text-decoration: none; color: initial; padding: 4px 10px; border: black; border-radius: 5px;}
    </style>
  </head>
  <body>
