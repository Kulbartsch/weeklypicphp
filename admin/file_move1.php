...
<form action="file_move2.php" method="post" enctype="multipart/form-data">
    ...
    <table>
        <tr>
            <td><input type="radio" id="timeframe_w" name="timeframe" value="Woche" checked required>
                <label for="timeframe_w">Woche</label></td>
            <td><input type="number" id="week_number" name="week_number" min="1" max="53" step="1=" value="1"></td>
        </tr>  <!-- TODO: use current week -->
        <tr>
            <td><input type="radio" id="timeframe_m" name="timeframe" value="Monat" required>
                <label for="timeframe_m">Monat</label></td>
            <td><input type="number" id="month_number" name="month_number" min="1" max="12" step="1=" value="1"></td>
        </tr> <!-- TODO: use current month -->
    </table>
    </p>
    <p></p>
